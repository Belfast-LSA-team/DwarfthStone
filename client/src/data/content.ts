...
export const firstNameError = "Имя должно содержать от 2 до 22 символов";
export const secondNameError = "Фамилия должно содержать от 2 до 22 символов";
